...
GOOS=linux GOARCH=amd64 go build -o "$OUTPUT_DIR/gophkeeper-client-linux" ./cmd/client
...
GOOS=darwin GOARCH=amd64 go build -o "$OUTPUT_DIR/gophkeeper-client-darwin" ./cmd/client
...
GOOS=windows GOARCH=amd64 go build -o "$OUTPUT_DIR/gophkeeper-client-windows.exe" ./cmd/client
